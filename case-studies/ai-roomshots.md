...
## Repo  
https://github.com/kismet-git/airoomshots_web
...
- **AI:** Google Gemini 2.5 Flash Image via Vercel AI Gateway  
- **Image processing:** Sharp  
- **Auth:** Supabase (email magic link + Google login)  
- **Storage:** Cloudflare R2 (planned), Supabase for metadata  
- **Infra:** Vercel  
- **Dev tools:** VS Code, GitHub, Codex  
- **Earlier attempts:** Replit, v0.dev, WordPress prototypes  
...
## January 2026  
**Goal:** Stop runner rugs from being cropped  
...
## Commit moment  
**Commit:** `feat(scene-spec): enforce size→room rules + aspect normalization`  
